    ...
    function AlertService () {
        ...
        function getService ($timeout, $sce) {
            ...
            function addAlert(alertOptions, extAlerts) {
                ...
                alertOptions.msg = msgForEnglish(alertOptions.msg);
                var that = this;
            ...
            function msgForEnglish(englishMsg) {
                if (englishMsg == 'Login already in use') {
                    return '该用户名已存在。';
                } else if (englishMsg == 'Email already in use') {
                    return '邮箱已被占用。';
                } else if (englishMsg == 'User created') {
                    return '用户创建成功。';
                } else if (englishMsg == 'User updated') {
                    return '用户信息更新成功。';
                } else if (englishMsg == 'User deleted') {
                    return '用户信息删除成功。';
                } else {
                    return englishMsg;
                }
