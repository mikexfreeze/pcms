...
angular
    .module('pcmsApp')
    .controller('JudgeConfigAddObserverCtrl', JudgeConfigAddObserverCtrl);

JudgeConfigAddObserverCtrl.$inject = ['$scope', '$stateParams', '$state', '$uibModal', '$uibModalInstance', '$q', 'toaster', 'PopJudgeConfig', 'User', 'configId', '$timeout'];

function JudgeConfigAddObserverCtrl($scope, $stateParams, $state, $uibModal, $uibModalInstance, $q, toaster, PopJudgeConfig, User, configId, $timeout) {
    var $ctrl = this;
