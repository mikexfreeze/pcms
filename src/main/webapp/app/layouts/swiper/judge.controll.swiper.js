/**
 * Created by Micheal Xiao on 2017/5/12.
 */
...
(function() {
    ...
    angular
        .module('pcmsApp')
        .controller('jdConSwiperCtrl', jdConSwiperCtrl);

    jdConSwiperCtrl.$inject = ['Swpier', '$scope', '$rootScope', '$state', 'Auth', '$localStorage', '$q', '$stateParams','$document'];

    function jdConSwiperCtrl (Swpier, $scope, $rootScope, $state, Auth, $localStorage, $q, $stateParams,$document) {
